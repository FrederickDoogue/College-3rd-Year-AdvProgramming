...
int main()
{
	...
	cout << endl << "ReplaceScore = " << mark << endl;
	...
	cout << endl << "FallDownScore = " << mark << endl;
	...
	cout << endl << "FindallScore = " << mark << endl;
	{
		...
		cout << endl << "FindallInScopel Score = " << mark << endl;
		//cout << variables;
	...
	cout <<endl << "Score = " << mark << endl;
	cout << "listStart 10," << replace << "," << falldown << "," << varsall << "," << varsScope << " listEnd";
